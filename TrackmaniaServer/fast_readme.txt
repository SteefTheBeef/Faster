...
I'll use it to annonce updates, which will come on : 
http://slig.free.fr/fast3.2/ , which you can look at
regulary too.
...
If you make plugins and some features/datas are missing, contact
me rather than modify fast files, so we will see together if main
files really need changes or if you can do things inside the plugin.
