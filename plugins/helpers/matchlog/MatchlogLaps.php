...
class MatchlogLaps {
    ...
    private static function endRace($challengeInfo, $isMatch) {
        ...
        self::writeCheckpointsToFile($players, $challengeInfo, $_GameInfos);
    ...
    private static function createCheckpointsFileOutputForPlayer($player, $cps, $challengeInfo) {
    ...
    private static function writeCheckpointsToFile($players, $challengeInfo, $gameInfo) {
        foreach ($players as $login => &$player) {
            $result = "";
            ...
            if ($player['FinalTime'] > 0) {
                ...
                if (!file_exists($fileName)) {
                    ...
                    fwrite($myfile, MatchlogLaps::createCheckpointsFileOutputForPlayer($player, $result, $challengeInfo));
                    fclose($myfile);
                    return;
                }
