...
class RulesPanelBuilder {
    static function build($login, $layout, $umConfig) {
        global $_players;
    ...
    static function qualification($layout, $umConfig) {
        ...
        $p2 = "Each qualification race consists of one warmup lap and {$layout['greenTextColor']}four\$fff regular laps. "
        ...
        $p3 = "The {$layout['greenTextColor']}top 24 players advances \$ffffrom the qualifications to the semi-final. "
            . "Points accumulated in the qualification will {$layout['greenTextColor']}carry-over to the semi-final.";
        $xml .= UMPanel::textLabel($layout, $p3, 24);

        $p4 = "\$oImportant: \$oOnly races driven on {$layout['greenTextColor']}this server "
    ...
    static function qualificationPoints($layout, UMConfig $umConfig) {
    ...
    static function semiFinalPoints($layout, UMConfig $umConfig) {
        ...
        $p1 = "The top 24 players from the qualification have a spot in the semi-final. "
            ...
            . "At this stage, points do {$layout['greenTextColor']}NOT \$fffcarry-over to the grand-final.";
